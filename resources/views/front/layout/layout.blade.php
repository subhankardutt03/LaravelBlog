...
<head>
  ...
  <link href="{{asset('front_assets/css/clean-blog.min.css')}}" rel="stylesheet">
...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="btn btn-success" href="{{url('admin/login')}}">Login</a>
          </li>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('{{asset('front_assets/img/home-bg.jpg')}}')">
  ...
  <script src="{{asset('front_assets/js/clean-blog.min.js')}}"></script>
